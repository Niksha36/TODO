    ...
    Column(
        ...
        Column(Modifier.padding(top = 28.dp, bottom = 16.dp)) {
            ...
            CustomAuthTextField(
                ...
                onTextChange = { onEvent(RegisterScreenEvent.OnEmailChange(it)) }
            )
        }
        ...
        Column(Modifier.padding(bottom = 24.dp)) {
            ...
            PasswordTextField(
                ...
                onPasswordChange = { onEvent(RegisterScreenEvent.OnRepeatPasswordChange(it)) },
                error = state.repeatPasswordFieldError
            )
        }
        val noPasswordErrors = state.passwordFieldError == null && state.repeatPasswordFieldError == null && state.password.isNotEmpty()
        val isNextButtonEnabled = state.isEmailCorrect == true  && noPasswordErrors
        Button(
        ...
        Row(
            ...
            Text("Already have an account?", style = MaterialTheme.typography.titleSmall, color = Color.White)
            Text(
                "Sign In",
